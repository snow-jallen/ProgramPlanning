...
31	\N	Students will know the basic data types, control structures, and programming approaches for a current programming language.  
32	\N	Students will be able to solve problems by developing algorithms and implementing those algorithms using a current programming language.
33	\N	Students will begin to understand the social responsibilities of the computing professional and the impact of computing on society
34	\N	Students will know some basic data structures, basic software methodologies, and machine level representation of data.
35	\N	Students will be able to apply appropriate software design methodologies for larger programs, use appropriate data structures, and use an object-oriented language.
36	\N	Students will be able to build a simple web site that organizes information effectively
37	\N	Students will be able to identify an organization for information based on its inherent structure (chronological, alphabetic, etc.).
38	\N	Students will be able to use cascading style sheets to create style standards for a web site.
39	\N	Students will be able to create a navigational framework that matches the content and genre of the site.
40	\N	Students will be able to explain separation of concerns as it applies to the design and implementation of a web site
41	\N	Students will be able to describe the issues involved in developing a web interface.
42	\N	Students will be able to summarize the need and issues involved in web site implementation and integration.
43	\N	Students will be able to explain why accessibility issues are an important consideration in web page development.
44	\N	Students will be able to design and implement a web interface
45	\N	Students will be able to compare/contrast graphic media file format characteristics such as color depth, compression and CODEC
46	\N	Students will be able to explain and compare media file formats including lossy vs. lossless compression, color palettes, streaming formats, and CODECs
47	\N	Students will be able to explain and compare the inter-operability of formats
48	\N	Demonstrate how server-side technology works.
49	\N	Develop with server-side technology. Complicated web development environments such as ASP.NET and PHP have a fairly substantial learning curve.
50	\N	Utilize databases in web applications.
51	\N	Implement common data models used in blogs, forums, and content management systems.
52	\N	Design software for web applications. This includes layered software architectures as well as tiered designs for scalability and reliability.
53	\N	Identify mechanisms for maintaining state in web applications. This is one of the most important topics in the course since it is the principal difference between web application development and non-web application development.
54	\N	Consume REST and SOAP web services.
55	\N	Design and implementing web security.
56	\N	Students will know many basic data structures, recursion, complexity analysis, and common sorting and searching algorithms.
57	\N	Students will be able to use appropriate data structures and data abstraction. They will be able to use recursion as a problem solving strategy. They will be able to analyze complexity of algorithms and use appropriate sorting and searching algorithms.
58	\N	Students will know many basic data structures, recursion, complexity analysis, and common sorting and searching algorithms.
59	\N	Students will be able to use appropriate data structures and data abstraction. They will be able to use recursion as a problem solving strategy. They will be able to analyze complexity of algorithms and use appropriate sorting and searching algorithms.
60	\N	Underststand software engineering principles.
61	\N	Specify and manage software project requirements.
62	\N	Perform basic software project management.
63	\N	Understand the impact of alternative software development practices like extreme programming (XP) and Agile.
64	\N	Perform unit testing of software.
65	\N	Create work product documentation.
66	\N	Perform project risk management.
67	\N	Work as an effective member of a software development team.
68	\N	Students will understand and be able to work with the number systems around which digital computer hardware is designed, including conversion between number systems, two complement binary numbers, and binary arithmetic.
69	\N	Students will be able to use Boolean algebra as a tool in the design of digital circuits which are to perform a given logic function, and to use Kamaugh maps to find the minimal realization of such circuits.  
70	\N	Students will have a basic understanding of digital logic to prepare him or her to transfer into the professional engineering program at a university, and there continue the study of digital logic at an advanced level.
71	\N	Students will understand characteristics of an instruction set architecture, an assembly language, assembly level machine organization, and performance and compilation issues.
72	\N	Students will be able to analyze computer system organization at the assembly language level, implement algorithms in assembly/machine language, and design a computer system at a block level.
73	\N	Students will be able to employ the public infrastructure as a Service (IaaS) cloud known as Amazon Web Services (AWS) to deploy an existing computer application using cloud computing technologies such as load balancing and auto-scaling.
74	\N	Students will be able to, as part of application deployment, use security controls and technologies available in AWS such as identity and access management, virtual private clouds, security groups, etc.
75	\N	Students will be able to appraise the usefulness of the above-mentioned controls and technologies in terms of relevan security principles and / or attach methods.
76	\N	Students will be able to understand the considerations of architecting a cloud solution.
77	\N	Students will be able to compare and contrast public IaaS with other cloud technologies and models, particularly with respect to resource requirements and security issues.
78	\N	Mechanisms and policies that enable the efficient illusion of concurrent execution of multiple programs upon one (or more) CPUs.
79	\N	Mechanisms and policies that enable a "virtual" address spaces that may be larger than allocated memory.
80	\N	Security mechanisms and policies that protect processes from unauthorized access to their memory or files.
81	\N	Data structures and algorithms used to organize persistent storage.
82	\N	How resources such as CPU time, memory, and persistent storage are managed and allocated.
83	\N	Challenges in concurrency and approaches to avoiding race conditions and deadlock.
84	\N	The intertwined role of interrupts, traps, paged and segmented memory translation, and supervisor mode in enabling multi-tasking, isolation, system calls, access to i/o devices, and timers.
85	\N	Coarse estimations of access time to persistent storage.
86	\N	Understand the tradeoffs between, use cases for, and theory behind different types of programming languages.
87	\N	Feel comfortable with their ability to learn and use unfamiliar programming languages.
88	\N	Be exposed to and implement programs in a wide variety of programming languages that are used in the software industry.
89	\N	Gather useful information about users and activities through asking, looking, learning, and experimenting with alternatives.
90	\N	Organize information about users into useful summaries with affinity diagrams.
91	\N	Convey user research findings with personas and scenarios.
92	\N	Learn and appreciate the skill of sketching as a process for user experience design.
93	\N	Learn to give and accept critiques of design ideas in a constructive manner.
94	\N	Demonstrate skills for low-fidelity prototyping and describe the strengths and weaknesses of a variety of prototyping methods.
95	\N	Appreciate the process of user experience design as a cyclical, iterative process.
96	\N	Understand the differences between usability and user experience.
97	\N	Analyze an interaction design problem and propose a user-centered process, justifying the process and identifying the trade-offs.
98	\N	Prepare high quality professional documentation and artifacts relating to the design process for preparation for a professional portfolio.
99	\N	Demonstrated use of design patterns to reinforce design principles.
100	\N	Developed vocabulary of object-oriented design patterns and principles.
101	\N	Awareness of increase ability to create quality software.
102	\N	Students will learn the techniques and tools to design, guild, and extract information from a database.
103	\N	Understand database design and the use of databases in applications.
104	\N	Understand the relational model, relational algebra, and SQL.
105	\N	Utilize database design and relational design principles based on dependencies and normal forms.
106	\N	Analyze complex business scenarios and create data models
107	\N	Implement their database design by creating a physical database using SQL
108	\N	Successfully implement indexes, views, transaction and integrity constraints.
109	\N	Successfully deliver a project which explores database design and management in web applications by utilizing appropriate features of SQL.
110	\N	Students will demonstrate understanding of distributed operating system and network protocols for process communication, synchronization, scheduling, exception and deadlock resolution.
111	\N	Students will demonstrate via use their understanding of client-server, web-based collaborative systems.
112	\N	Students will demonstrate understanding of parallel computing.
113	\N	Students will demonstrate their ability to solve concurrency issues.
114	\N	Students will exercise APIs for distributed application development.
115	\N	Students will become familiar with a mobile applications development environment and life cycle. They will know the basics of the Android environment, tools for creating Android applications, the Android approach to structuring applications, basic user interfaces, and the application life cycle.
116	\N	Students will be able to design, implement, test, and debug mobile applications.
117	\N	Students will be able to write a software project management plan, addressing issues of risk analysis, schedule, costs, team organization, resources, and technical approach.
118	\N	Students will be able to define the technology and practices associated with each and a variety of software development life cycle models and explain the strengths, weaknesses, and applicability of each.
119	\N	Students will be able to define the relationship between software products and overall products (if embedded), or the role of the product in the organizational product line.
120	\N	Students will be able to explain the purpose and limitations of software development standards and be able to apply sensible tailoring where needed.
121	\N	Students will be able to utilize software development standards for documentation and implementation.
122	\N	Students will be able to apply leadership principles to project management.
123	\N	Students will understand the connections and interactions between science, technology and society.
124	\N	Students will understand current Intellectual Property debates and the relevant laws governing them.
125	\N	Students will understand privacy concerns posed by modern information gathering methods.
126	\N	Students will be exposed to industry standard codes of ethics put out by ACM and IEEE.
127	\N	Students will understand the history of computing and their place in it.
128	\N	Students will be exposed to philosophical bases for evaluating computer ethics.
129	\N	Students will be able to recognize and use common GUI framework elements, patterns, and concepts.
130	\N	Students will know a modern GUI framework and be comfortable working within it.
131	\N	Students will be familiar with testing and validation strategies for UI frameworks including unit testing, integration testing, and end to end testing.
132	\N	Students will be able to design algorithms to solve a variety of computational problems. They will be able to employ any of the following techniques: divide-and-conquer, dynamic programming, greedy approaches, and graph algorithms.
133	\N	Students will be able to analytically reason about and prove the correctness/incorrectness and complexity of algorithmic solutions to problems.
134	\N	Students will be able to implement algorithms in software.
135	\N	Students will be able to reason about the computational complexity of a computation problem by reduction to other problems.
136	\N	Students will demonstrate an ability to reduce overall software development defect rates.
137	\N	Students will demonstrate the importance of the time spent at the front end of the development cycle to lay the foundation for a successful project.
138	\N	Students will demonstrate an ability to eliminate or nearly eliminate compile and test defects.
139	\N	Students will be able to accurately estimate the time requirements to build software.
140	\N	Students will be able to explain security design principles.
141	\N	Students will be able to apply security principles when they analyze and design projects.
142	\N	Students will be able to implement projects using security primitives.
143	\N	Students will be able to utilize tools for security analysis.
144	\N	Students will be able to evaluate the security of project implementations.
145	\N	Students will be able to apply a systematic approach to common engineering problems in the context of their practicum project.
146	\N	Students will demonstrate an ability to apply theories and principles of Software Engineering to problems encountered in industry.
147	\N	Students will demonstrate an ability to exercise and improve time and stress management skills as well as problem-solving skills
\.
...
SELECT pg_catalog.setval('public.learningobjective_id_seq', 147, true);
...
ALTER TABLE ONLY public.skill
    ADD CONSTRAINT "skill_LO_fk" FOREIGN KEY (id) REFERENCES public.learningoutcome(id);
